# Bitbucket Cloud API Spec

> The Bitbucket Cloud API schema over time.

![Atlassian Bitbucket](assets/logo-gradient-blue-bitbucket.png)

The Atlassian Bitbucket Cloud API documentation is located [here](https://developer.atlassian.com/cloud/bitbucket/rest/intro/) on the Atlassian Developer website.
